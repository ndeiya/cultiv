...
<div class="max-w-6xl mx-auto px-4 py-8 mb-24 md:mb-0">
    <div class="flex justify-between items-center mb-8">
        <div class="flex items-center gap-2">
            ...
            <h2 class="text-3xl font-black tracking-tight">Farm Reports Management</h2>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="bg-white dark:bg-slate-900 p-4 rounded-xl border border-primary/10 shadow-sm">
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="text-xs font-medium text-slate-500 uppercase">Total Reports</span>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 p-4 rounded-xl border border-orange-500/20 shadow-sm">
            ...
            <div class="flex items-baseline gap-2">
                ...
                <span class="text-2xl font-bold text-orange-500"><?= $open ?></span>
            </div>
        </div>
        <div class="bg-white dark:bg-slate-900 p-4 rounded-xl border border-green-500/20 shadow-sm">
            <div class="flex items-center gap-2 mb-2">
                <span class="material-symbols-outlined text-sm text-green-500">check_circle</span>
                <span class="text-xs font-medium text-slate-500 uppercase">Resolved</span>
            </div>
            <div class="flex items-baseline gap-2">
                <?php $resolved = count(array_filter($reports, fn($r) => $r['status'] === 'resolved')); ?>
                <span class="text-2xl font-bold text-green-500"><?= $resolved ?></span>
            </div>
        </div>
    </div>

    <!-- Filters -->
    <form method="GET" action="/owner/reports" class="flex flex-col md:flex-row gap-4 items-center mb-6">
